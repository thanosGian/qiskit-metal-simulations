...
cpw1 = RouteMeander(
    ...
    options={
        ...
        "meander": {"asymmetry": "+551.75um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Q2", "pin": "bus_12"},
            "start_pin": {"component": "Q1", "pin": "bus_12"},
        },
        "total_length": "10.31mm",
        "trace_gap": "cpw_gap",
    },
    type="CPW",
)
...
cpw2 = RouteMeander(
    ...
    name="cpw2",
    options={
        "_actual_length": "9.640000000000002 mm",
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "250um",
        ...
        "meander": {"asymmetry": "-551.75um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Q2", "pin": "bus_23"},
            "start_pin": {"component": "Q3", "pin": "bus_23"},
        },
        "total_length": "9.64mm",
        "trace_gap": "cpw_gap",
    },
...
cpw3 = RouteMeander(
    ...
    name="cpw3",
    options={
        "_actual_length": "9.339999999999996 mm",
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "250um",
        ...
        "meander": {"asymmetry": "+413.75um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Q4", "pin": "bus_34"},
            "start_pin": {"component": "Q3", "pin": "bus_34"},
        },
        "total_length": "9.34mm",
        "trace_gap": "cpw_gap",
    },
...
cpw4 = RouteMeander(
    ...
    options={
        ...
        "meander": {"asymmetry": "-413.75um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Q4", "pin": "bus_14"},
            "start_pin": {"component": "Q1", "pin": "bus_14"},
        },
        "total_length": "9.97mm",
        "trace_gap": "cpw_gap",
    },
...
Readout1 = RouteMeander(
    ...
    options={
        ...
        "meander": {"asymmetry": "+150um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Launch_RO_Q1", "pin": "tie"},
...
Readout3 = RouteMeander(
    ...
    options={
        ...
        "meander": {"asymmetry": "+150um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Launch_RO_Q3", "pin": "tie"},
            "start_pin": {"component": "Q3", "pin": "readout"},
        },
        "total_length": "8.31mm",
        "trace_gap": "cpw_gap",
    },
...
Readout2 = RouteMeander(
    ...
    options={
        ...
        "meander": {"asymmetry": "+200um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Launch_RO_Q2", "pin": "tie"},
...
Readout4 = RouteMeander(
    ...
    name="Readout4",
    options={
        "_actual_length": "8.080000000000002 mm",
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "0um",
        ...
        "meander": {"asymmetry": "+200um", "spacing": "200um"},
        "pin_inputs": {
            "end_pin": {"component": "Launch_RO_Q4", "pin": "tie"},
            "start_pin": {"component": "Q4", "pin": "readout"},
        },
        "total_length": "8.08mm",
        "trace_gap": "cpw_gap",
    },
...
Charge_Line1 = RouteAnchors(
    ...
    name="Charge_Line1",
    options={
        "_actual_length": "3.4152517741486648 mm",
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "225um",
...
Charge_Line3 = RouteAnchors(
    ...
    name="Charge_Line3",
    options={
        "_actual_length": "3.277251774148665 mm",
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "225um",
...
Charge_Line2 = RouteAnchors(
    ...
    name="Charge_Line2",
    options={
        "_actual_length": "4.865735698864887 mm",
        "anchors": {0: array([-2.0, 2.5])},
        "fillet": "99.99um",
        "lead": {
            "end_jogged_extension": "",
            "end_straight": "100um",
            "start_jogged_extension": OrderedDict([(0, ["L", "300um"])]),
